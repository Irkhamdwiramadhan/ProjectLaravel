...
Route::delete('/kendaraan/delete/{id}', [KendaraanController::class, 'destroy'])->name('kendaraan.destroy');
    ...
    Route::get('/area_palkir/show', [Area_palkirController::class, 'show'])->name('area_palkir.show');
...
Route::post('/kendaraan/register', [KendaraanController::class, 'register'])->name('kendaraan.register');